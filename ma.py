...
while True:
    ...
    if a == 1:
        ...
        try:
            ...
            version = requests.get('https://raw.githubusercontent.com/Haamthelord1/Scrapper-Add/main/version.txt')
        except:
            print(f'{r} You are not connected to the internet')
            print(f'{r} Please connect to the internet and retry')
            exit()
        if float(version.text) > 1.2:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/Haamthelord1/Scrapper-Add/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/Haamthelord1/Scrapper-Add/main/ma.py')
            ...
            print(f'{lg}[i] Your Tool is already up to date')
            input('Press enter to goto main menu...')
    elif a == 5:
        clr()
        banner()
